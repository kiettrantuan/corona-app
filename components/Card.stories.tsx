...
LongBodyTextWithNoSpace.args = {
    heading: 'Header',
    body:
        'ThisIsALongWithoutSpaceTextLoremipsumdolorsitamet,consectetueradipiscingelitAeneancommodoligulaegetdolor.Aeneanmassa.Cumsociisnatoquepenatibusetmagnisdisparturientmontes,nasceturridiculusmus.',
    link: '#',
    amount: 2,
    imgsrc: 'https://via.placeholder.com/100',
};
